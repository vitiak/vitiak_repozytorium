...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryUser userWith0Books = new LibraryUser("FirstName0", "LastName0", "10000");
        LibraryUser userWith1Books = new LibraryUser("FirstName1", "LastName1", "11111");
        LibraryUser userWith5Books = new LibraryUser("FirstName5", "LastName5", "15555");

        when(libraryDatabaseMock.listBooksInHandsOf(userWith0Books)).thenReturn(resultListOf0Books);
        when(libraryDatabaseMock.listBooksInHandsOf(userWith1Books)).thenReturn(resultListOf1Books);
        ...
        List<Book> theListOfBooks1 = bookLibrary.listBooksInHandsOf(userWith1Books);
        // Then
